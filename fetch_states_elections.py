"""
Fetch States Elections markets from Polymarket Gamma API.
Filters by tag_id=100164, excludes tag ids 264, 189, 1101, and 102786.
...
# Tags to exclude by ID (264, 189 original + 1101 US Elections + 102786 Nov Elections)
EXCLUDED_TAG_IDS = {264, 189, 1101, 102786}

def fetch_states_elections_markets(limit: int = 250) -> List[Dict]:
    """
    Fetch closed States Elections markets from Polymarket Gamma API.
...
def main():
    print("=" * 60)
    print("Fetching States Elections Markets from Polymarket")
    print("=" * 60)

    # Fetch markets
    markets = fetch_states_elections_markets(limit=250)
    ...
    # Save to CSV
    output_path = "states_elections_markets.csv"
