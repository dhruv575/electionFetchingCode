"""
Fetch US Elections markets from Polymarket Gamma API.
Filters by tag_id=1101 (US Elections), excludes tag ids 264 and 189.
...
def fetch_us_elections_markets(limit: int = 250) -> List[Dict]:
    """
    Fetch closed US Elections markets from Polymarket Gamma API.
...
def main():
    print("=" * 60)
    print("Fetching US Elections Markets from Polymarket")
    print("=" * 60)

    # Fetch markets
    markets = fetch_us_elections_markets(limit=250)
    ...
    # Save to CSV
    output_path = "us_elections_markets.csv"
